  ...
  return (
    <div className="recipe-meister">
      {state.showUI === 'recipe-view' && (
        ...
        >
          {({ title, description, recipeImg, keywords, ingredients, instructions, dishType }) => (
            <>
      ...
      {state.showUI === "home-view" && (
        <div id="controls">
          ...
          />
          <button className="btn btn-black" onClick={() => dispatch({ type: "show-add-recipe" })}>Add a Recipe</button>
        </div>
      )}
